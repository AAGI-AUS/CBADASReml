# Contributing to CBADASReml

This outlines how to propose a change to CBADASReml. For a detailed
...
- We use [{cli}](https://cli.r-lib.org/) for errors, warnings and other
  messages.
...
[Contributor Code of
Conduct](https://aagi-aus.github.io/CBADASReml/CODE_OF_CONDUCT.md). By
